...
hop_dong.ngay_lam_hop_dong,hop_dong.ngay_ket_thuc,ifnull(dich_vu.chi_phi_thue,0)+ifnull(hop_dong_chi_tiet.so_luong,0)*ifnull(dich_vu_di_kem.gia,0) as 'tong_tien1',
